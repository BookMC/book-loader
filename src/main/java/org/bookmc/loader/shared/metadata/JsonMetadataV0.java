package org.bookmc.loader.shared.metadata;
...
import org.bookmc.loader.impl.loader.reliance.ModSuggestionReliance;
        ...
        if (obj.has("suggests")) {
            ...
            for (Map.Entry<String, JsonElement> entry : suggestions) {
                ...
                if (element.isJsonPrimitive()) {
                    ...
                    reliances.add(new ModSuggestionReliance(id, version, indicator));
                }
            }
